...
export default function AddProduct() {
    ...
    const inputClass =
        "w-full px-2 py-1 text-sm bg-white border border-gray-300 rounded focus:outline-none focus:border-gray-800 transition-colors";
    const labelClass = "block text-[10px] font-bold text-gray-500 uppercase tracking-tight mb-0.5";
    const sectionHeaderClass =
        "col-span-full text-xs font-bold text-gray-800 border-b border-gray-200 mt-2 pb-1 mb-1 uppercase tracking-wider";
