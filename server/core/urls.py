...
def master_api_root(request):
    ...
    return Response({
        ...
        "4. Draft Purchase API": request.build_absolute_uri('/api/draft-purchase/'),
        "5. Sale API": request.build_absolute_uri('/api/sale/'),
        "6. Draft Sale API": request.build_absolute_uri('/api/draft-sale/'),
        "7. Stock / Inventory API": request.build_absolute_uri('/api/stock/'),
        "8. Brand API": request.build_absolute_uri('/api/brand/'),
        "9. Supplier API": request.build_absolute_uri('/api/supplier/'),
        "10. Payment API": request.build_absolute_uri('/api/payment/'),
        "11. Capital API": request.build_absolute_uri('/api/capital/'),
        "12. Expense API": request.build_absolute_uri('/api/expense/'),
        "13. Account API": request.build_absolute_uri('/api/account/'),
        "14. User API": request.build_absolute_uri('/api/users/'),
        "15. Customer Ledger API": request.build_absolute_uri('/api/customerledger/'),
...
urlpatterns = [
    ...
    path('api/draft-purchase/', include('draftPurchase.urls')),
